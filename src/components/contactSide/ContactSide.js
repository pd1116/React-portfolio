...
class ContactSide extends React.Component {
    ...
    state = {
        ...
        message: '',
        ContactItems: [
            {id: 1, title: 'E-mail', body: 'diprathmesh123@gmail.com'},
            {id: 2, title: 'Address', body: 'Flat no 6.Chaitanya appartment Swapna Nagari Garkheda Aurangabad'},
            {id: 3, title: 'Phone', body: '+91 7666570401'},
